...
module.exports = {
    ...
    try {
      ...
      return res.json({
        ...
        user: {
          ...
          phoneNumber: existingUser.phoneNumber, // Include phone number in response
        },
      });
    } catch (err) {
  ...
  async registerUser(req, res) {
    const { firstName, lastName, email, password, phoneNumber } = req.body; // Added phoneNumber
    ...
    try {
      ...
      // Create new user with email already verified and phone number
